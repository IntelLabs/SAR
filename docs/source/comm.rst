...
You can specify the name of the socket that will be used for communication with ``SOCKET_NAME`` environment variable (if not specified, the first available socket will be selected).
